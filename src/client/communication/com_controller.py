...
class Callback:
    ...
    def set_callback_client(self) -> None:
        ...
        IO.on(MessageTypesToClients.new_message, self.receive_message)

    def receive_message(self, data: Message, io: IO) -> None:
        self.__controller.get_interface_from_data().add_new_message(data)
        self.__controller.get_interface_from_ihm_game().notify_new_message()

    def profil_edited(self, data: Profile, io: IO) -> None:
        profile = data
        self.__controller.get_interface_from_data().update_user_profile(profile)
    ...
    def connection_success(self, data: dict, io: IO) -> None:
        ...
        games: List[PublicGame] = data["games"]
    ...
    def create_game_success(self, data: LocalGame, io: IO) -> None:
        ...
        self.__controller.get_interface_from_ihm_main().start_waiting_screen(data)
    ...
    def player_join_game(self, player: Profile, io: IO) -> None:
    ...
    def play_a_move(self, data: dict, io: IO) -> None:
        ...
        self.__controller.get_interface_from_data().add_move_to_local_game(
            move, is_finished
        )
        self.__controller.get_interface_from_ihm_game().update_game()
...
class IHMGameCallsComm_Impl(I_IHMGameCallsComm):
    ...
    def send_message(self, message: Message) -> None:
        self.comm_controller.get_io().write(
            {"id": MessageTypesToServer.message, "data": message}
        )
