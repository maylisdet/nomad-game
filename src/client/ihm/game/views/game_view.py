...
from client.ihm.game.popups.draw_popup_window import DrawPopupWindow
from client.ihm.game.popups.move_not_possible_window import (
    MoveNotPossibleWindow,
)
from client.ihm.game.popups.winner_popup_window import (
    WinnerPopupWindow,
)
...
class GameView(View):
    def __init__(
        ...
        self.white_player = WhitePlayerContainer(pygame_manager)
        self.red_player = RedPlayerContainer(pygame_manager)
        ...
        self.winner_pop_up = WinnerPopupWindow(pygame_manager, ui, controller)
        self.draw_pop_up = DrawPopupWindow(pygame_manager, ui, controller)
        ...
        self.add_pop_up(self.winner_pop_up)
        self.add_pop_up(self.draw_pop_up)
