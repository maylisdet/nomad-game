...
from client.ihm.main.components.register_view.register_error import RegisterError
...
class RegisterView(View):
    def __init__(
        ...
        self.register_error = RegisterError(pygame_manager)
