...
from client.ihm.main.popups.create_game import CreateGame
from client.ihm.main.popups.error_creating_game_pop_up import ErrorCreatingGamePopUp
...
class HomeView(View):
    def __init__(
        ...
        self.players_list = PlayersList(pygame_manager, self.home_panel)
        self.live_games_section_title = SectionTitle(
            pygame_manager, self.home_panel, "Parties en cours", 425, 10
        )
        self.games_list = GamesList(pygame_manager, self.home_panel)
        ...
        self.create_game_pop_up = CreateGame(pygame_manager, ui, controller)
        self.error_creating_game_pop_up = ErrorCreatingGamePopUp(
        ...
        self.add_pop_up(self.error_creating_game_pop_up)
        self.add_pop_up(self.waiting_game_pop_up)
        self.add_pop_up(self.create_game_pop_up)
